...
test.describe('THORChain Wiki Governance Smoke Tests', () => {
  test('governance page shows incidents and milestones', async ({ page }) => {
    ...
    await expect(page.locator('#current-recovery').getByText(/Restart, patch, migration, and ADR-028 review/i)).toBeVisible();
    ...
    await expect(page.locator('#current-recovery').getByText(/GG20 exploit record is promoted for current recovery tracking/i)).toBeVisible();
    await expect(page.locator('#current-recovery').getByText(/ADR-028 remains a needs-review recovery-path record/i)).toBeVisible();
    ...
    await expect(page.locator('#current-recovery').getByText(/Updated ADR, proposal, or official report source/i)).toBeVisible();
    await expect(page.locator('#current-recovery').getByText(/Do not claim ADR-028 has restored losses/i)).toBeVisible();
