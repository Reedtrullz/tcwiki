export default function EconomicsPage() {
  return (
    <div className="pt-[52px] py-16 px-6 max-w-7xl mx-auto">
      ...
      <h2 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-5">RUNE Token</h2>
      ...
      <h2 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-5">Supply & Emission</h2>
      ...
      <h2 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-5">Fee Structure</h2>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-12">
        {[
          ...
          <div key={f.fee} className="p-5 rounded-lg bg-surface-elevated border border-border">
      ...
      <h2 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-5">Incentive Pendulum</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-12">
      ...
      <h2 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-5">CLP Formula</h2>
      <div className="p-5 rounded-lg bg-surface-elevated border border-border font-mono text-xs text-slate-400 space-y-1">
