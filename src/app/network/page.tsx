    ...
    <PageContainer>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
        {[
          ...
          { label: 'TCY Distributions', value: liveStateValue(networkStatus?.tcyStakeDistributionPaused) },
          { label: 'TCY Unstaking', value: liveStateValue(networkStatus?.tcyUnstakingPaused) },
          { label: 'TCY Trading', value: liveStateValue(networkStatus?.tcyTradingPaused) },
          { label: 'Secured Assets', value: liveStateValue(networkStatus?.securedAssetsPaused) },
        ].map((stat) => (
