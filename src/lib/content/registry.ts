...
export const CONTENT_ENTRIES: ContentEntry[] = [
  ...
  },
  {
    ...
    body: 'Governance ADR Mimir halt trading halt signing pause LP incidents exploit reports GG20 THORFi unwind TCY recovery source-backed history. Use incident records and security deep dives for exact cryptographic root-cause wording.',
...
export const TASK_INTENT_GUIDES: TaskIntentGuide[] = [
  ...
  },
  {
    ...
    searchTerms: ['swap refund', 'swap failed', 'why did my swap refund', 'refund reason', 'stale quote', 'minimum output', 'memo invalid', 'outbound failed', 'quote failed', 'swap lifecycle', 'inbound outbound refund', 'streaming swap', 'streaming swaps'],
    confidence: 'curated',
    reviewedAt: '2026-07-05',
    nextReviewDue: '2026-08-05',
  ...
  },
  {
    ...
    question: 'What source should I use for GG20, DKLS, Schnorr, Paillier, or key-sign failure claims?',
    href: '/deep-dives/tss',
  ...
  },
  {
    ...
    searchTerms: ['why paused', 'mimir key', 'pause reason', 'halt reason', 'operational evidence', 'source warning', 'LP paused', 'StreamingSwapPause', 'streaming swap pause', 'HaltMemoless', 'memoless halt', 'RUNEPoolHaltDeposit', 'RUNEPool deposit halt'],
    confidence: 'official',
    reviewedAt: '2026-07-04',
    nextReviewDue: '2026-08-04',
