...
4. Whether apparently conflicting source terminology is merely wording drift or is supported by current code, endpoints, and controls; do not resolve it by assumption.
5. The interface-specific implementation, because a listed wallet or app is not an endorsement or proof of current support.
6. The source freshness date. Static docs explain design; live endpoint evidence explains current availability.
