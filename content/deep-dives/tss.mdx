...
1. Whether the claim is about historical GG20 behavior, the May 2026 exploit, the current running release, or a future migration path.
...
- Current vault safety, restart completion, or exploit recovery completion.
